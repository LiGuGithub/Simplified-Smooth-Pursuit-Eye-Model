function ssemlinearkcon = ssemlinearkcon(T_dot,E_dot,t_Iteration,alpha)
%% Simulation of Simplified Smooth Pursuit System with CONSTANT GAIN and LINEAR CORRECTION. 
